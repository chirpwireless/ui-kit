...
import { SearchIcon as l } from "../../icons/SearchIcon/index.es.js";
...
const P = ({ value: e, sx: o, placeholder: n, onChange: i, size: p = "medium" }) => {
  const r = c(), a = u(r), { t: m } = x("uiKit", { keyPrefix: "SearchInput" });
      ...
      InputProps: {
        startAdornment: /* @__PURE__ */ t.jsx(
          h,
          {
            ...
            children: /* @__PURE__ */ t.jsx(l, { width: "16px", height: "16px" })
          }
        )
      }
    }
