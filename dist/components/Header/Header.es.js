...
const g = (r) => r.palette.mode === m.Dark ? t(r).neutral.grey1 : t(r).neutral.white, x = l("header", {
...
})), H = ({ logo: r, rightSlot: o, onMenuOpen: n, showMenuButton: i = !0, transparent: a }) => /* @__PURE__ */ e.jsxs(x, { transparent: a, children: [
  /* @__PURE__ */ e.jsxs(
    s,
    {
      direction: "row",
