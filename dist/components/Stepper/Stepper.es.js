...
const s = ({ activeStep: n, handleSetStep: r, steps: o, sx: m }) => {
  const x = p(), i = g(x), e = i.primaryColors.accentLight2 ?? i.primaryColors.accentLight;
  return o != null && o.length ? /* @__PURE__ */ c.jsx(u, { direction: "row", gap: "8px", height: "24px", alignItems: "center", justifyContent: "center", mb: "32px", sx: m, children: o.map((t) => /* @__PURE__ */ c.jsx(
    a,
    {
      sx: {
