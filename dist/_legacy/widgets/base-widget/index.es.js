...
import { Container as f, Header as g, HeaderContent as m } from "./style.es.js";
...
import { Loader as u } from "../../loader/index.es.js";
...
const tt = ({
  ...
  mainContainerSx: s,
  headerSx: e,
  leftHeaderContentSx: n,
  rightHeaderContentSx: x,
  headerSubheaderContainerSx: c,
  renderLeftHeaderContent: a,
  renderRightHeaderContent: d,
  renderMainContent: l,
  renderSubHeader: t,
  onContainerClick: o
}) => {
  ...
  }, i = /* @__PURE__ */ r.jsxs(g, { sx: e, children: [
    /* @__PURE__ */ r.jsx(m, { sx: n, children: a }),
    /* @__PURE__ */ r.jsx(m, { sx: x, children: d })
  ] });
  return /* @__PURE__ */ r.jsx(f, { sx: j, onClick: o, children: p ? /* @__PURE__ */ r.jsx(u, { size: "large" }) : /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    t ? /* @__PURE__ */ r.jsxs(h, { sx: { gap: "12px", ...c }, children: [
      i,
      t
    ] }) : i,
    l
