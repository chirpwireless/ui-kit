import { styled as a, Slider as d } from "@mui/material";
const l = a(d)(({ theme: i }) => ({
  "--gradient": `linear-gradient(90deg, ${i.palette.additionalColors.blue} 0%, ${i.palette.additionalColors.yellow} 49%, ${i.palette.alerts.alert} 100%)`,
  height: "6px",
  padding: 0,
  "& .MuiSlider-rail": {
