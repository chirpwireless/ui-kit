...
import { Stack as t } from "@mui/material";
import "../../select-indicator/style.es.js";
import { SvgLeftArrowBlack as p } from "../../../left-arrow-black-Chbf14Ma.js";
...
import { IconButton as e } from "../../icon-button/index.es.js";
...
import { Title as n, WidgetTypeName as s } from "./styles.es.js";
...
const Or = ({ title: i, typeText: o, onBackClick: m }) => /* @__PURE__ */ r.jsxs(t, { direction: "row", gap: 2, alignItems: "center", children: [
  ...
  /* @__PURE__ */ r.jsxs(t, { gap: 2, children: [
    ...
    /* @__PURE__ */ r.jsx(s, { variant: "overline", children: o })
  ] })
] });
export {
