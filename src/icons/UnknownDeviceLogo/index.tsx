...
export const UnknownDeviceLogoBig = (props: SVGProps<SVGSVGElement>) => (
    <svg width="172" height="172" viewBox="0 0 172 172" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
