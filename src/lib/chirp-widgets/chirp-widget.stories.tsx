...
import { ChirpWidget } from '@chirp/ui/lib';
...
export const String: Story = {
    render: () => {
        const [configTypeState, setConfigTypeState] = useState<WidgetTypes.Text | WidgetTypes.Group>(WidgetTypes.Text);

        const handleSwitchView = () => {
            if (configTypeState === WidgetTypes.Text) {
                setConfigTypeState(WidgetTypes.Group);
            } else {
                setConfigTypeState(WidgetTypes.Text);
            }
        };
...
export const Boolean: Story = {
    render: () => {
        const [configTypeState, setConfigTypeState] = useState<WidgetTypes.Boolean | WidgetTypes.Group>(
            WidgetTypes.Boolean,
        );

        const handleSwitchView = () => {
            if (configTypeState === WidgetTypes.Boolean) {
                setConfigTypeState(WidgetTypes.Group);
            } else {
                setConfigTypeState(WidgetTypes.Boolean);
            }
        };
...
export const Graphic: Story = {
    render: () => {
        const [configTypeState, setConfigTypeState] = useState<WidgetTypes.Graphic | WidgetTypes.Group>(
            WidgetTypes.Graphic,
        );

        const handleSwitchView = () => {
            if (configTypeState === WidgetTypes.Graphic) {
                setConfigTypeState(WidgetTypes.Group);
            } else {
                setConfigTypeState(WidgetTypes.Graphic);
            }
        };
